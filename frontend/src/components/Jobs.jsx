    ...
    useEffect(()=>{
        if(searchedQuery){
            const filteredJobs = allJobs.filter((job)=>{
                ...
                // job.type.toLowerCase().includes(searchedQuery.toLowerCase()) || 
                // job.company.toLowerCase().includes(searchedQuery.toLowerCase()) || 
                // job.company.toLowerCase().includes(searchedQuery.toLowerCase()) || 
                // job.skills.some((skill)=>skill.toLowerCase().includes(searchedQuery.toLowerCase())) || 
                // job.jobRole.some((role)=>role.toLowerCase().includes(searchedQuery.toLowerCase())) 
            })
